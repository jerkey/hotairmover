// THIS IS A MOVING BRACKET TO POSITION A HOT-AIR SOLDERING IRON

screwDia = 3.5; // diameter of screwhole for pivoting
thickness = 10; // default thickness of parts

difference() {
  cube(size = [outerDia,screwHeight + outerDia/2,outerDia], center = true); // block that H is carved from
